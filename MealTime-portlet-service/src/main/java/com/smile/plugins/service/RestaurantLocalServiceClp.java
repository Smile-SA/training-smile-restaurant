 ...
 * @generated
 */
public class RestaurantLocalServiceClp implements RestaurantLocalService {
    ...
    public RestaurantLocalServiceClp(
        ...
        _methodName24 = "updateRestaurant";
        ...
        _methodName26 = "getRestaurantByGroupId";

        _methodParameterTypes26 = new String[] { "long" };

        _methodName27 = "getRestaurantByGroupId";

        _methodParameterTypes27 = new String[] { "long", "int", "int" };

        _methodName28 = "getRestaurantByGroupId";
        ...
        _methodName29 = "getRestaurantsCountByGroupId";
    ...
    public com.smile.plugins.model.Restaurant addRestaurant(
        ...
        return (com.smile.plugins.model.Restaurant) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.smile.plugins.model.Restaurant createRestaurant(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { restaurantId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.smile.plugins.model.Restaurant deleteRestaurant(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { restaurantId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.smile.plugins.model.Restaurant fetchRestaurant(long restaurantId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { restaurantId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.smile.plugins.model.Restaurant getRestaurant(long restaurantId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName13,
                    _methodParameterTypes13, new Object[] { restaurantId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.smile.plugins.model.Restaurant> getRestaurants(
        ...
        return (java.util.List<com.smile.plugins.model.Restaurant>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.smile.plugins.model.Restaurant addRestaurant(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName23,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(restaurant),
