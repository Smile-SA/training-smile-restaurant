 ...
 * @generated
 */
public class RestaurantServiceClp implements RestaurantService {
    ...
    public RestaurantServiceClp(InvokableService invokableService) {
    ...
    public com.smile.plugins.model.Restaurant deleteRestaurant(
        ...
        try {
            returnObj = _invokableService.invokeMethod(_methodName5,
                    _methodParameterTypes5, new Object[] { restaurantId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
