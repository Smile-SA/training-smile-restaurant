...
/**
 * Provides the local service interface for Restaurant. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author guillaume Lenoir
 * @see RestaurantLocalServiceUtil
...
public interface RestaurantLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link RestaurantLocalServiceUtil} to access the restaurant local service. Add custom service methods to {@link com.smile.plugins.service.impl.RestaurantLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
